defmodule SongbasketExTauriWeb do
  @moduledoc """
  ...
  This can be used in your application as:
      ...
      use SongbasketExTauriWeb, :controller
      use SongbasketExTauriWeb, :html
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: SongbasketExTauriWeb.Layouts]
  ...
  defp html_helpers do
    quote do
      ...
      import SongbasketExTauriWeb.CoreComponents
      import SongbasketExTauriWeb.Gettext
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: SongbasketExTauriWeb.Endpoint,
        router: SongbasketExTauriWeb.Router,
        statics: SongbasketExTauriWeb.static_paths()
    end
  end
