defmodule SongbasketExTauri.BasketManager do
  use GenServer
  alias SongbasketExTauri.{Basket, Events, PubSub, Flow}
  @db_name Application.compile_env!(:songbasket_ex_tauri, :basket_db_name)
