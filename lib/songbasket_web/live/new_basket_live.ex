defmodule SongbasketWeb.NewBasketLive do
  use SongbasketWeb, :live_view

  # require SongbasketWeb
  # SongbasketWeb.surface_live_component(id: "new-basket")

  alias Songbasket.{Api, PubSub, Flow, Events, Auth}
